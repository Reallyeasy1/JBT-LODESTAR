  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[#f5f1e8] px-5 text-center text-emerald-950">
      <div className="max-w-md rounded-3xl border border-stone-200 bg-white p-7 shadow-sm">
        ...
        <h1 className="mt-4 text-2xl font-black">The event could not be loaded</h1>
        <p className="mt-2 text-sm leading-6 text-stone-600">Check the database connection, then try again.</p>
        <button
          type="button"
          onClick={reset}
